...
The first install activates **Yier & Bubu · Cozy Coding** and also seeds it into the **Saved themes** tray menu.
...
Open the repository's [new issue page](https://github.com/FrankLaurance/Yier-Bubu-Codex-Dream-Skin/issues/new/choose) and choose the bug form when reporting a problem. Include the Windows version, Codex source, reproduction steps, and relevant log lines. Remove secrets, `auth.json`, relay tokens, and private conversation content.
